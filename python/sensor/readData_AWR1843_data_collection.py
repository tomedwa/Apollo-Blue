...
while True:
    try:
        ...
        if dataOk:
            ...
            if (count_down == 10):
                npy_path = os.path.join(DATA_PATH, actions[action_index], str(sequence_number), str(count))
                np.save(npy_path, keypoints)
            
            print(sequence_number, count_down, count)
